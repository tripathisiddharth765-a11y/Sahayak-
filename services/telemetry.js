const droneData = {
  'ALPHA-1': { lat: 24.8360, lon: 91.9170, alt: 120, spd: 8.4, hdg: 214, bat: 87, sig: -62, name: 'ALPHA-1', mode: 'AUTO' },
  'BRAVO-2': { lat: 24.8341, lon: 91.9203, alt: 85,  spd: 6.1, hdg: 178, bat: 54, sig: -70, name: 'BRAVO-2', mode: 'AUTO' },
  'ECHO-3':  { lat: 24.8285, lon: 91.9115, alt: 200, spd: 9.8, hdg: 310, bat: 22, sig: -76, name: 'ECHO-3',  mode: 'RTL'  },
  'DELTA-4': { lat: 24.8410, lon: 91.9248, alt: 150, spd: 7.3, hdg: 90,  bat: 91, sig: -58, name: 'DELTA-4', mode: 'AUTO' },
};
